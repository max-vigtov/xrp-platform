...
<div class="container-fluid px-4">
    ...
    <div class="container w-100 border border-3 border-primary rounded p-4 mt-3" >
        <form action="{{route('provider.update',['provider'=>$provider])}}" method="post" enctype="multipart/form-data">
            @method('PATCH')
            @csrf
            <div class="row g-3">
                    ...
                    {{-- Person Type --}}
                    <div class="col-md-12">
                        <label for="person_type" class="form-label">Tipo de entidad: <span class="fw-bold">{{ strtoupper($provider->person->person_type) }}</span></label>
                    </div>

                    {{-- Business Name --}}
                    <div class="col-md-6 mb-2" id="box-business-name">

                        @if ($provider->person->person_type == 'Física')
                        ...
                        @endif
                        <input type="text" name="business_name" id="business_name" class="form-control" value="{{ old('business_name', $provider->person->business_name) }}"></input>
                        @error('business_name')
                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <input type="text" name="address" id="address" class="form-control" value="{{ old('address', $provider->person->address) }}">
                        @error('address')
                        <small class="text-danger">{{'*'.$message }}</small>
                         @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="document_id" id="document_id">
                            ...
                            @if ($provider->PERSON->document_id == $item->id)
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" name="document_number" id="document_number" class="form-control" value="{{ old('document_number',$provider->person->document_number) }}">
